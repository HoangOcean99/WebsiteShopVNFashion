...
public class ProductService extends DBContext {
    ...
    public void insert(Product product) {
        ...
        String sql = "INSERT INTO Products (Product_name, Description, Gender, CategoryID, Price, Trait, Items, ImageProduct1, ImageProduct2, ImageProduct3) "
                + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            ps.setString(6, product.getTrait());
            ps.setString(7, product.getItems());
            ps.setString(8, product.getImageProduct1());
            ps.setString(9, product.getImageProduct2());
            ps.setString(10, product.getImageProduct3());
