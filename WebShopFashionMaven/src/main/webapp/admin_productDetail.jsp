                        ...
                        <div class="detail-group">
                            ...
                            <div class="product-info-grid">
                                ...
                                <select id="gender" name="gender">
                                    <option value="Nam" <% if("Male".equals(product.getGender())){ %>selected <% } %>>Nam</option>
                                    <option value="Nữ" <% if("Female".equals(product.getGender())){ %>selected <% } %>>Nữ</option>
                                ...
                                <select id="category" name="categoryID">
                                    ...
                                    <option value="3" <% if(product.getCategoryID() == 4){ %>selected <% } %>>Áo Tấc</option>
                                </select>
                        ...
                        <div class="detail-group">
                            ...
                            <table class="data-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><input type="text" name="materialName" value="<%= productMaterials.get(i).getMaterialName() %>"></td>
                                        <td><button type="button" class="button-remove">Xóa</button></td>
                                    </tr>
                                    <% } %>
                                </tbody>
                            </table>
                            <button type="button" class="button-add">+ Thêm Chất liệu</button>
                        </div>
                        ...
                        <div class="detail-group">
                            ...
                            <table class="data-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><input type="text" name="size" value="<%= productDetails.get(i).getSize() %>" required></td>
                                        <td><input type="number" name="stock" value="<%= productDetails.get(i).getStockQuantity() %>" min="0" class="stock-low" required></td>
                                        <td><button type="button" class="button-remove">Xóa</button></td>
                                    </tr>
                                    <% } %>
                                </tbody>
                            </table>
                            <button type="button" class="button-add">+ Thêm Kích cỡ/Tồn kho</button>
                        </div>
                    </form>
                    <% } %>
                </div>
